...
from neat.rbt import Node, RBTree
...
class DefaultGenome(object):
    ...
    def configure_crossover(self, genome1, genome2, config):
        ...
        for key, cg1 in parent1.connections.items():
            ...
            if cg2 is None:
                ...
                self.connections.insert(key, cg1.copy())
            else:
                # Homologous gene: combine genes from both parents.
                self.connections.insert(key, cg1.crossover(cg2))
    ...
    def add_connection(self, config, input_key, output_key, weight, enabled):
        ...
        # print("---------------------")
        # print("key_add" + str(key))
        # print("b_add_connection" + str(self.connections))
        self.connections.insert(key, connection)
        # print("a_add_connection" + str(self.connections))
    ...
    def mutate_add_connection(self, config):
        ...
        # print("----------------------------")
        # print(cg.key)
        self.connections.insert(cg.key, cg) ############################################################## cg o cg.values()
    ...
    def mutate_delete_node(self, config):
        ...
        # print("-----------------")
        # print("items: " + str(self.connections.items()))
        for k, v in self.connections.items():
            if del_key in v.key:
                connections_to_delete.add(v.key)

        # print("-----------------")
        # print("connections_to_delete: " + str(connections_to_delete))
        for key in connections_to_delete:
            self.connections.delete(self.connections.search(key))
    ...
    def distance(self, other, config):
        ...
        if self.connections.keys() or other.connections.keys():

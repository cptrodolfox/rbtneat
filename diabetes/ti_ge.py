...
for i in range(s_blocks):
    ...
    t, g = kfold(input_block, output_block, 'config-feedforward')
    times_graph_ind.append(t)
    generations_graph_ind.append(g)
...
# for i in range(s_blocks):
#     for pattern in attr:
#         block = (len(pattern)-1)/s_blocks
#         inputs_block.append(tuple(pattern[:int(block*(i+1))]))
#     print(inputs_block)
#     blocks.append(int(block*(i+1)))
#     t, g = kfold(inputs_block, outputs,'config-block')
#     times_graph_attr.append(t)
#     generations_graph_attr.append(g)
